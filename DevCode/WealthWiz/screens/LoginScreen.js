    ...
    <>
      <View style={styles.login}>
        ...
        <View style={[styles.homeIndicator, styles.backgroundPosition]}>
          ...
          <View style={[styles.seperator, styles.bank1IconPosition]} />
        </View>
        <Pressable
        ...
        />
        <StatusBar style={styles.bank1IconPosition} translucent={true} />
        <FormField1
        ...
        <ImageBackground
          style={[styles.bank1Icon1, styles.bank1IconPosition]}
          resizeMode="cover"
